  ...
  return (
      ...
      <div className="sticky top-0 h-screen overflow-hidden">
        <div className="absolute top-0 right-auto bottom-0 left-0 z-10">
          <motion.div className="relative flex flex-col gap-[24vw] pt-[55vh]" style={{ y: useActive.yFirst }}>
            ...
            <div className="relative z-20 mt-8 flex items-center justify-center gap-x-4 md:mt-10">
              <div className="relative group">
                ...
                <Link href="/nfts">
                  <Button
                    variant="outline"
                    className="relative z-10 text-xl md:text-2xl lg:text-3xl px-10 py-8 md:px-14 md:py-10 font-bold text-blue-400 border-blue-400 border hover:text-blue-300 hover:border-transparent hover:bg-gray-900 transition-all duration-300 shadow-[0_0_15px_rgba(59,130,246,0.5)] hover:shadow-[0_0_25px_rgba(59,130,246,0.7)] bg-neutral-900/80 rounded"
                    title="BUY A SLUGGER"
                  >
                    BUY A SLUGGER
                  </Button>

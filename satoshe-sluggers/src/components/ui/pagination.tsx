...
function PageJumpInput({
  ...
  return (
    <input
      ...
      onBlur={handleBlur}
            className="w-14 h-8 px-2 text-center bg-neutral-900 border border-brand-pink text-sm text-brand-pink focus:ring-2 focus:ring-brand-pink focus:outline-none"
...
export default function NFTPagination({
  ...
  return (
    <div className="sticky bottom-0 w-full bg-neutral-900 py-3 px-6 rounded-t-lg border-t border-neutral-800 z-30">

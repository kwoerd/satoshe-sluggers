    ...
    >
      ...
      <FilterContext.Provider value={filterContextValue}>
        ...
        <RarityTiersCategory
          ...
          icon={
            <Image
              src="/media/icons/nft-sidebar-categories/rarity-tier-orange.svg"
              alt="Rarity Tiers"
              width={18}
              height={18}
        ...
        <FilterCategory
          ...
          icon={
            <Image
              src="/media/icons/nft-sidebar-categories/background-blue.svg"
              alt="Background"
              width={18}
              height={18}
        ...
        <FilterCategory
          ...
          twoColumns={false}
          icon={
            <Image src="/media/icons/nft-sidebar-categories/skin-tone-yellow.svg" alt="Skin Tone" width={18} height={18} className="text-amber-400" sizes="18px" />
          }
        ...
        <FilterCategory
          ...
          color="red"
          twoColumns={false}
          icon={<Image src="/media/icons/nft-sidebar-categories/shirt-red.svg" alt="Shirt" width={18} height={18} className="text-red-400" sizes="18px" />}
        ...
        <FilterCategoryWithSubcategories
          ...
          color="green"
          twoColumns={false}
          icon={<Image src="/media/icons/nft-sidebar-categories/hair-green.svg" alt="Hair" width={18} height={18} className="text-green-400" sizes="18px" />}
        ...
        <FilterCategory
          ...
          color="cyan"
          twoColumns={false}
          icon={<Image src="/media/icons/nft-sidebar-categories/eyewear-blue.svg" alt="Eyewear" width={18} height={18} className="text-cyan-400" sizes="18px" />}
          options={[
        ...
        <FilterCategoryWithSubcategories
          ...
          twoColumns={false}
          icon={
            <Image src="/media/icons/nft-sidebar-categories/headwear-purple.svg" alt="Headwear" width={18} height={18} className="text-purple-400" sizes="18px" />
          }

        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="relative z-20 text-center">
            <div className="mb-5 md:mb-6">
              <Image
                src="/media/brands/satoshe-sluggers/satoshe-sluggers-hero-off-white.svg"
            ...
            <div className="relative z-20 mt-8 flex items-center justify-center gap-x-4 md:mt-10">
              <div className="relative group">
                ...
                <div className="absolute inset-0 rounded-sm bg-blue-500/40 blur-xl group-hover:bg-blue-400/60 transition-all duration-300 scale-125"></div>
                <Link href="/nfts">
                  <Button
                    variant="outline"
                    className="relative z-10 text-xl md:text-2xl lg:text-3xl px-10 py-8 md:px-14 md:py-10 font-bold text-blue-400 border-blue-400 border-2 hover:text-blue-300 hover:border-transparent hover:bg-background transition-all duration-300 shadow-[0_0_15px_rgba(59,130,246,0.5)] hover:shadow-[0_0_25px_rgba(59,130,246,0.7)] bg-neutral-900/80 rounded-sm"
                    title="BUY A SLUGGER"
                  >
                    BUY A SLUGGER
                  </Button>

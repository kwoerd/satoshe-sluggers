...
export default function NFTPagination({
  ...
  return (
    <div className="sticky bottom-0 w-full bg-neutral-900 py-3 px-4 rounded-t-sm border-t border-neutral-800 z-30">
      <div className="flex flex-col sm:flex-row justify-center items-center gap-3">
        <div className="flex items-center gap-1">
          ...
          >
                <ChevronFirst className="h-4 w-4 text-off-white" />
          </Button>
          <Button
            variant="outline"
            size="sm"
            ...
            style={{ borderRadius: "50%" }}
          >
                <ChevronLeft className="h-4 w-4 text-off-white" />
          </Button>
            ...
            {pageNumbers.map((page, index) => {
              ...
              return (
                <Button
                  ...
                  className={
                    currentPage === page
                      ? "bg-brand-pink hover:bg-brand-pink-hover text-xs h-8 w-8 p-0 text-off-white"
                      : "bg-neutral-800 border-neutral-700 hover:bg-neutral-700 text-xs h-8 w-8 p-0 text-off-white"
                  }
                      style={{ borderRadius: "50%" }}
          ...
          <Button
            ...
            style={{ borderRadius: "50%" }}
          >
                <ChevronRight className="h-4 w-4 text-off-white" />
          </Button>
          <Button
            variant="outline"
            size="sm"
            ...
            style={{ borderRadius: "50%" }}
          >
                <ChevronLast className="h-4 w-4 text-off-white" />
          </Button>
        </div>
